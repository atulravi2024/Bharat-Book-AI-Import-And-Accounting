...
const tabs = [
  ...
  { id: 'warehouse', label: 'Warehouses', type: 'WarehouseMaster', prop: 'warehouseMasters', setter: 'setWarehouseMasters' },
  { id: 'uoms', label: 'UOMs', type: 'UomMaster', prop: 'uomMasters', setter: 'setUomMasters' },
  { id: 'stockGroup', label: 'Stock Groups', type: 'StockGroupMaster', prop: 'stockGroupMasters', setter: 'setStockGroupMasters' },
  { id: 'gst', label: 'HSN', type: 'GstMaster', prop: 'gstMasters', setter: 'setGstMasters' },
  { id: 'brands', label: 'Brands', type: 'BrandMaster', prop: 'brandMasters', setter: 'setBrandMasters' },
  { id: 'categories', label: 'Categories', type: 'CategoryMaster', prop: 'categoryMasters', setter: 'setCategoryMasters' },
  { id: 'color', label: 'Colors', type: 'any', prop: 'colorMasters', setter: 'setColorMasters' },
  { id: 'size', label: 'Sizes', type: 'any', prop: 'sizeMasters', setter: 'setSizeMasters' },
  { id: 'variant', label: 'Variants', type: 'any', prop: 'variantMasters', setter: 'setVariantMasters' },
  { id: 'dimension', label: 'Dimensions', type: 'any', prop: 'dimensionMasters', setter: 'setDimensionMasters' },
  { id: 'sku', label: 'SKUs', type: 'any', prop: 'skuMasters', setter: 'setSkuMasters' },
  { id: 'priceList', label: 'Price List', type: 'any', prop: 'priceListMasters', setter: 'setPriceListMasters' },
  { id: 'weight', label: 'Weights', type: 'any', prop: 'weightMasters', setter: 'setWeightMasters' },
  { id: 'volume', label: 'Volumes', type: 'any', prop: 'volumeMasters', setter: 'setVolumeMasters' },
  { id: 'grades', label: 'Grades', type: 'any', prop: 'gradeMasters', setter: 'setGradeMasters' }
];
...
console.log('done splitting item master');
