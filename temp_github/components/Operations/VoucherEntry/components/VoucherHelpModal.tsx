    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
      <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl p-0 overflow-hidden flex flex-col max-h-[85vh] dark:bg-gray-800">
        <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-gray-50/50 dark:border-gray-800">
          <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2 dark:text-white"><HelpCircle size={20} className="text-blue-500" /> Help & Instructions</h3>
        ...
        <div className="overflow-y-auto flex-1 p-6 space-y-4 text-sm text-gray-700 dark:text-gray-200">
          ...
          <div className="border border-gray-200 rounded-xl overflow-hidden dark:border-gray-700">
            ...
            >
              <span className="font-bold text-gray-900 flex items-center dark:text-white"><Layout size={16} className="mr-2 text-blue-500"/> Section-by-Section Guide</span>
            ...
            {showHelpFunctionality && (
              <div className="p-3 bg-white border-t border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                <div className="space-y-4 text-gray-600 dark:text-gray-300">
                  <div>
                    <h4 className="font-bold text-gray-800 text-sm mb-1 px-2 py-1 bg-blue-50 text-blue-800 outline outline-blue-100 rounded inline-block dark:text-gray-100">1. Header Details</h4>
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 text-sm mb-1 px-2 py-1 bg-blue-50 text-blue-800 outline outline-blue-100 rounded inline-block dark:text-gray-100">2. Entry Lines (Item Details)</h4>
                    <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 text-sm mb-1 px-2 py-1 bg-blue-50 text-blue-800 outline outline-blue-100 rounded inline-block dark:text-gray-100">3. Voucher Summary & Taxes</h4>
                    <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 text-sm mb-1 px-2 py-1 bg-blue-50 text-blue-800 outline outline-blue-100 rounded inline-block dark:text-gray-100">4. Contextual Actions & Save</h4>
                    <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 text-sm mb-1 px-2 py-1 bg-blue-50 text-blue-800 outline outline-blue-100 rounded inline-block dark:text-gray-100">5. Keyboard Masterclasses</h4>
                    <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 text-sm mb-1 px-2 py-1 bg-blue-50 text-blue-800 outline outline-blue-100 rounded inline-block dark:text-gray-100">6. Tax & Discount Evaluation Rules</h4>
                    <ul className="list-disc pl-5 mt-2 space-y-1 text-sm">
          ...
          <div className="border border-gray-200 rounded-xl overflow-hidden dark:border-gray-700">
            <button 
              ...
              className="w-full flex items-center justify-between p-3 bg-gray-50 hover:bg-gray-100 transition-colors dark:bg-gray-900 dark:hover:bg-gray-600"
            >
              <span className="font-bold text-gray-900 flex items-center dark:text-white"><Zap size={16} className="mr-2 text-blue-500"/> Pro Tips & Workflows</span>
