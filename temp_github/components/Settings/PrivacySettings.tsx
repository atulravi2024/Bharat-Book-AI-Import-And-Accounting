        ...
        <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-premium-slate-100 relative dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-100 dark:bg-gray-900 dark:border-gray-800">
                    <h4 className="font-bold text-gray-900 text-sm mb-4 uppercase tracking-widest dark:text-white">Data Retention</h4>
                    <div className="space-y-4">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div>
                                <p className="text-xs text-gray-800 font-bold dark:text-gray-100">Keep audit logs for</p>
                                <p className="text-[10px] text-gray-500 font-medium max-w-sm mt-1 dark:text-gray-400">Duration to retain history of who uploaded maps and when AI changed its classification confidence.</p>
                            </div>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-4 border-t border-gray-100 dark:border-gray-800">
                            <div>
                                <p className="text-xs text-gray-800 font-bold dark:text-gray-100">Anonymous usage reporting</p>
                                <p className="text-[10px] text-gray-500 font-medium max-w-sm mt-1 dark:text-gray-400">Help improve the AI models by securely sharing purely structure-level extraction logic (no PII or custom data).</p>
                            </div>
                ...
                <div className="p-5 bg-gray-50 rounded-xl border border-gray-100 flex items-center justify-between dark:bg-gray-900 dark:border-gray-800">
                    <div>
                        <p className="font-bold text-gray-900 text-sm dark:text-white">Export Enterprise Data</p>
                        <p className="text-xs text-gray-500 font-medium mt-1 dark:text-gray-400">Download all your records in standard JSON/CSV format.</p>
                    </div>
                    <button className="px-5 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-xl text-xs font-bold hover:bg-gray-100 transition-colors dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-600">Request Export</button>
                </div>
            </div>
        </div>
    );
