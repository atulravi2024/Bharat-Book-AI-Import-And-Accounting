...
const tabs = [
  ...
  { id: 'ledgers', label: 'General Ledgers', type: 'LedgerMaster',
    th: `
  ...
  { id: 'banks', label: 'Bank Masters', type: 'LedgerMaster',
    th: `
        <th className="p-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">Ledger Group</th>
  ...
  { id: 'contacts', label: 'Contacts', type: 'any',
    th: `<th className="p-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">Details / Description</th>`,
    td: `<td className="p-4 text-sm text-gray-500 dark:text-gray-400">{m.description || '-'}</td>`
  },
  { id: 'accountGroups', label: 'Groups', type: 'any',
    th: `<th className="p-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">Details / Description</th>`,
    td: `<td className="p-4 text-sm text-gray-500 dark:text-gray-400">{m.description || '-'}</td>`
  },
  { id: 'warehouses', label: 'Locations', type: 'any',
    th: `<th className="p-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">Details / Description</th>`,
    td: `<td className="p-4 text-sm text-gray-500 dark:text-gray-400">{m.description || '-'}</td>`
  },
  { id: 'costCenters', label: 'Cost Centers', type: 'any',
    th: `<th className="p-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">Details / Description</th>`,
    td: `<td className="p-4 text-sm text-gray-500 dark:text-gray-400">{m.description || '-'}</td>`
  }
];
        ...
        <div className="flex flex-col h-full animate-in fade-in duration-300">
            <div className="p-4 bg-gray-50/30 border-b border-gray-100 flex justify-between items-center dark:bg-gray-800/30 dark:border-gray-800">
                ...
                <button onClick={() => { setEditingId(null); setFormData(
                    ${tab.id === 'parties' ? '{name: "", type: "Customer"}' : (tab.id === 'vendors' ? '{name: "", type: "Vendor"}' : (tab.id === 'banks' ? '{name: "", group: "Bank Accounts"}' : '{name: ""}'))}
...
console.log('done splitting ledger master correctly');
