      ...
      <>
          <div className="p-4 bg-gray-50/30 border-b border-gray-100 flex justify-between items-center dark:bg-gray-800/30 dark:border-gray-800">
            <div className="relative max-w-md w-full mr-4">
              ...
              <input
                type="text"
                placeholder={t("Search Staff (Internal Contacts)...")}
                value={searchTerm}
            ...
            <div className="flex items-center">
              ...
              >
                ...
                <span className="hidden lg:inline-block">{t("Add Staff")}</span>
              </button>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-auto custom-scrollbar min-h-0">
            {filteredStaffData.length > 0 ? (
              <HorizontalScrollArea className="w-full">
                ...
                <thead>
                  <tr className="bg-gray-50 border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <th className="p-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">{t("Staff Member")}</th>
                    <th className="p-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">{t("Role & Department")}</th>
                    <th className="p-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">{t("Contact Info")}</th>
                    <th className="p-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">{t("Status & Joining")}</th>
                    <th className="p-4 text-[10px] font-bold uppercase tracking-widest text-gray-400">{t("Duties / Description")}</th>
                      ...
                      >
                            ...
                            <div>
                              ...
                              <div className="flex items-center space-x-1.5 mt-0.5 whitespace-nowrap">
                                <span className="text-[10px] text-gray-400 font-medium font-mono">
                                  {t("Joined:")} {m.dateOfJoining || t("N/A")}
                                </span>
                                {m.gender && (
                                  <span
                        ...
                        <td className="p-4">
                          <div className="text-sm">
                            <div className="font-bold text-gray-800 dark:text-gray-100">
                              {m.designation || t("Staff Associate")}
                            </div>
                            <div className="text-[11px] text-gray-500 font-medium">
                              {m.department || t("General Operations")}
                            </div>
                          </div>
                        </td>
                        <td className="p-4">
                        ...
                        <td className="p-4 whitespace-nowrap">
                          <div className="flex flex-col space-y-1">
                            ...
                            >
                              {isActive ? t("ACTIVE / WORKING") : t("RESIGNED")}
                            </span>
              ...
              <div className="p-12 text-center flex flex-col justify-center items-center">
                ...
                <p className="text-gray-500 dark:text-gray-400">{t("No staff found in this sub-page")}</p>
              </div>
            )}
          </div>
        </>
