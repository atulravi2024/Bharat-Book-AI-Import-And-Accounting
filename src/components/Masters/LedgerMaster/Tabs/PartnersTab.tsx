        ...
        <div className="flex flex-col h-full animate-in fade-in duration-300">
            <div className="p-4 bg-gray-50/30 border-b border-gray-100 flex justify-between items-center dark:bg-gray-800/30 dark:border-gray-800">
                <div className="relative max-w-md w-full mr-4">
                    ...
                    <input type="text" placeholder={t("Search Partners...")} value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="form-input pl-10 pr-4 text-sm" />
                </div>
                <div className="flex items-center">
                    ...
                    <button onClick={() => { 
                        ...
                        <AddIcon className="lg:mr-2" /> <span className="hidden lg:inline-block">{t("Add Partner")}</span>
                    </button>
                </div>
            </div>
            ...
            <div className="flex-1 overflow-auto custom-scrollbar min-h-0">
                {filteredData.length > 0 ? (
                                    ...
                                    <td className="p-4">
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-[11px] font-bold uppercase tracking-widest text-indigo-500 mt-0.5 dark:text-indigo-400">{t("Bilateral Partner")}</div>
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <div className="p-12 text-center flex flex-col justify-center items-center">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">{t("No Partners found")}</p>
                    </div>
                )}
            </div>
              ...
              <div className={`bg-white w-full h-full overflow-hidden flex flex-col dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-2xl animate-in zoom-in-95 ${formSettings.currentModalMode === 'fullscreen' ? 'rounded-none max-w-full max-h-full' : 'rounded-2xl max-w-5xl max-h-[90vh]'}`}>
                <div className="flex justify-between items-center px-4 py-2 border-b border-gray-100 bg-gray-50/50 dark:border-gray-800 shrink-0">
                  <h2 className="font-bold text-base text-gray-900 flex items-center dark:text-white">
                    {editingId ? t('Edit') : t('Add')} {t('Partner')}
                  </h2>
                        ...
                        <div className="overflow-y-auto flex-1 p-6 space-y-4 custom-scrollbar">
                            <div className="form-grid gap-4">
                                ...
                                <div className="form-field-wrapper col-span-1 md:col-span-2">
                                    ...
                                    <input type="text" value={formData.description || ''} onChange={e => setFormData({ ...formData, description: e.target.value })} className="form-input" placeholder={t("Dual purpose customer & vendor details...")} />
                                </div>
                                ...
                                <div className="form-field-wrapper">
                                    ...
                                    >
                                        <option value="Both">{t("Both (Customer & Vendor)")}</option>
                                    </select>
                                </div>
                                <div className="form-field-wrapper">
            ...
            {deleteConfirmation?.isOpen && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl p-6 w-full max-w-sm text-center shadow-2xl animate-in zoom-in-95 dark:bg-gray-800">
                        ...
                        <h2 className="font-bold text-xl mb-2 text-gray-900 dark:text-white">{t("Delete Partner?")}</h2>
