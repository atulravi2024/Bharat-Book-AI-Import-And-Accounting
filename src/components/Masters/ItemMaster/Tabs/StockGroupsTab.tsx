        ...
        <div className="flex flex-col h-full animate-in fade-in duration-300">
            <div className="p-4 bg-gray-50/30 border-b border-gray-100 flex justify-between items-center dark:bg-gray-800/30 dark:border-gray-800">
                <div className="relative max-w-md w-full mr-4">
                    ...
                    <input type="text" placeholder="Search Stock Groups..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="form-input pl-10 pr-4 text-sm" />
                </div>
                <div className="flex items-center">
                    ...
                    <AddIcon className="lg:mr-2" /> <span className="hidden lg:inline-block">Add Stock Group
                </span></button>
                </div>
            </div>
...
<input type="text" value={formData.name || ''} onChange={e => setFormData({...formData, name: e.target.value})} className="form-input" placeholder="Enter name..." />
                                ...
                                <div className="form-field-wrapper col-span-1">
                                    <label className="form-label dark:text-gray-400">Parent Group</label>
                                    <input type="text" value={formData.parentGroup || ''} onChange={e => setFormData({...formData, parentGroup: e.target.value})} className="form-input bg-transparent" placeholder="e.g. Raw Materials" />
                                </div>
                                <div className="form-field-wrapper col-span-1">
                                    <label className="form-label dark:text-gray-400">Default Costing Method</label>
                                ...
                                <div className="form-field-wrapper col-span-1">
                                    <label className="form-label dark:text-gray-400">Default Tax Rate (%)</label>
                                    <input type="number" value={formData.defaultTaxRate || ''} onChange={e => setFormData({...formData, defaultTaxRate: parseFloat(e.target.value)})} className="form-input bg-transparent" placeholder="e.g. 18" />
                                </div>
