            ...
            <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        />
                        <p className="text-[10px] text-gray-500 font-medium mt-2 px-2 dark:text-gray-400">This name appears on exported reports, vouchers, and GST validation checks.</p>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <p className="text-[10px] text-gray-500 font-medium mt-2 px-2 dark:text-gray-400">Determines financial reporting periods and tax logic mapping.</p>
                </div>
                ...
                <div>
                    ...
                    <p className="text-[10px] text-gray-500 font-medium mt-2 px-2 dark:text-gray-400">Production syncs directly to standard ERP outputs. Demo is sandboxed with dummy values.</p>
                </div>

                <div className="pt-4 border-t border-premium-slate-100 flex justify-end dark:border-gray-700">
                    <button 
                        onClick={handleSave}
