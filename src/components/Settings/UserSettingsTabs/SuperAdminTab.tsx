      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">MAC Address</span>
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">Time Zone</span>
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">Default Login Retry Limit</span>
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">Security Clearance Level</span>
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">Connected Database Node</span>
            <span className="text-[11px] font-black text-gray-800 dark:text-white flex items-center">
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">Emergency Protocols</span>
            <span className="text-xs font-black text-rose-600 dark:text-rose-400 flex items-center">
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">Disaster Failover Region</span>
            <span className="text-[11px] font-black text-gray-800 dark:text-white flex items-center">
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">Last Auth Token Hash</span>
            <span className="text-xs font-mono font-bold text-gray-800 dark:text-white flex items-center">
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">Kernel Version</span>
            <span className="text-[11px] font-black text-gray-800 dark:text-white flex items-center">
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">Host OS</span>
            <span className="text-[11px] font-black text-gray-800 dark:text-white flex items-center">
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">Current Uptime</span>
            <span className="text-[11px] font-black text-gray-800 dark:text-white flex items-center">
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">Network Topology</span>
            <span className="text-[11px] font-black text-gray-800 dark:text-white flex items-center">
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-4 rounded-2xl border border-gray-100 dark:border-gray-800 relative group">
            <span className="block text-[9px] font-black uppercase text-gray-400 dark:text-gray-500 mb-1">Audit Logging Level</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="bg-slate-50 dark:bg-gray-900 p-5 rounded-2xl border border-gray-100 dark:border-gray-800">
            <span className="block text-[10px] font-black uppercase tracking-widest text-gray-400 dark:text-gray-500 mb-3 border-b border-gray-200 dark:border-gray-700 pb-2">Recent Root Interventions</span>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-mono text-gray-500">2026-05-24 14:02 UTC</span>
                <span className="text-[10px] font-bold text-gray-800 dark:text-gray-200 uppercase">Enforced Global 2FA Auth</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-mono text-gray-500">2026-05-22 09:15 UTC</span>
                <span className="text-[10px] font-bold text-gray-800 dark:text-gray-200 uppercase">Revoked Suspicious Admin Token</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-mono text-gray-500">2026-05-20 18:30 UTC</span>
        ...
        <div className="bg-red-50 dark:bg-red-950/20 p-5 rounded-2xl border border-red-200 dark:border-red-900/50 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
             <span className="block text-[11px] font-black uppercase tracking-widest text-red-600 dark:text-red-400 mb-1">System Wide Lock Down</span>
             <p className="text-[10px] text-red-500 uppercase font-semibold">Immediate suspension of all non-Super Admin traffic over the network.</p>
          </div>
