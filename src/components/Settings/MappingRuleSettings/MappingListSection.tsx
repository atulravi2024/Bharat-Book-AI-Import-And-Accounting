                ...
                <div className={`bg-white border-t border-gray-50 ${!toggles.sectionMappingListEnabled && 'opacity-50 pointer-events-none grayscale'} dark:bg-gray-800`}>
                    ...
                    <div className="py-6 px-8 border-b border-gray-100 dark:border-gray-800">
                        <div className="flex items-center justify-between border-b border-gray-200 pb-2 mb-4 dark:border-gray-700">
                            <h4 className="font-bold text-gray-900 text-sm uppercase tracking-widest dark:text-white">Bank Statement Mapping Rules</h4>
                        </div>
                        <p className="text-xs text-gray-500 mb-6 font-medium dark:text-gray-400">Map specific keywords or regex patterns in bank statement narrations to precise Transaction Types (Payment, Receipt, Contra) or Ledgers.</p>
                    ...
                    <div className="py-6 px-8 border-b border-gray-100 dark:border-gray-800">
                        ...
                        <p className="text-xs text-gray-500 mb-6 font-medium dark:text-gray-400">Link your active Indian bank masters to their account numbers.</p>
                        ...
                        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                            <h4 className="font-bold text-gray-900 text-sm mb-4 uppercase tracking-widest dark:text-white">Transaction Classification Logic</h4>
                            <div className="space-y-4">
                                <div className="flex border-b border-gray-100 pb-4 flex-col md:flex-row md:items-center justify-between gap-4 dark:border-gray-800">
                                    <div>
                                        <p className="text-sm font-bold text-gray-700 dark:text-gray-200">Bank Charges & Fees Keywords</p>
                                    </div>
                                ...
                                <div className="flex border-b border-gray-100 pb-4 flex-col md:flex-row md:items-center justify-between gap-4 dark:border-gray-800">
                                    <div>
                                        <p className="text-sm font-bold text-gray-700 dark:text-gray-200">Cash Flow / ATM Identifiers</p>
                                    </div>
                                ...
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                    <div>
                                        <p className="text-sm font-bold text-gray-700 dark:text-gray-200">Self Transfer Tags</p>
                                    </div>
                    ...
                    <div className="bg-gray-50 p-8 border-y border-gray-100 shadow-sm border-blue-100/50 dark:bg-gray-900 dark:border-gray-800">
                        <h4 className="font-bold text-gray-900 text-sm mb-4 uppercase tracking-widest border-b border-gray-200 pb-2 dark:text-white dark:border-gray-700">Keyword To Ledger Mapping Engine</h4>
