        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 bg-white rounded-xl border border-gray-100 shadow-sm dark:bg-gray-800 dark:border-gray-800">
                <div>
                    ...
                    <p className="text-gray-500 mt-1 text-sm dark:text-gray-400">Additional GST Compliance Metrics</p>
                </div>
            </div>
                    ...
                    <div className="divide-y divide-gray-100 dark:divide-gray-800">
                        {data.reports?.map((report: any, i: number) => (
                            <div key={i} className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 hover:bg-gray-50 transition-colors dark:hover:bg-gray-700">
                                <div>
                                    <h4 className="font-bold text-gray-800 dark:text-gray-100">{report.name}</h4>
                                    <p className="text-xs text-gray-500 mt-1 uppercase tracking-wider dark:text-gray-400">{report.id}</p>
                                </div>
                                <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8">
                                    <div className="flex items-center">
                                        <span className="text-xs font-medium text-gray-500 w-20 dark:text-gray-400">Due Date:</span>
                                    ...
                                    <button className="px-4 py-2 bg-white border border-gray-200 text-gray-700 text-xs font-bold rounded-lg hover:bg-gray-50 hover:text-blue-600 transition-colors dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-700">
                                        View Details
                                    </button>
                                </div>
                            </div>
