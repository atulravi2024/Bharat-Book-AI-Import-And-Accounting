              ...
              return (
                <div className="animate-in fade-in slide-in-from-top-2 duration-300 flex flex-col flex-grow">
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
                    ...
                    {/* Subtotal */}
                    <MetricBox label="Subtotal" value={`₹ ${(totals.subtotal || 0).toFixed(2)}`} />
                    ...
                    {/* Taxable Amount */}
                    <MetricBox label="Taxable Amount" type="primary" value={`₹ ${(totals.amountAfterDiscount || totals.subtotal || 0).toFixed(2)}`} />
