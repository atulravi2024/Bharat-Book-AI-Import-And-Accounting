...
import { AccountingVoucherProps, VoucherEntryViewProps } from '../types';
...
import { useJournalBarcodeScanner } from './useJournalBarcodeScanner';
import { useJournalVoucherTotals } from './useJournalVoucherTotals';
import { useJournalVoucherNavigation } from './useJournalVoucherNavigation';
...
export const useJournalVoucherLogic = (props: AccountingVoucherProps) => {
  ...
  const totals = useJournalVoucherTotals({
    rows,
    activeTab,
    headerDetails,
  });
