...
interface UseCreditNoteVoucherNavigationProps {
  initialVoucher: any;
  activeTab: string;
  vouchers: any[];
  setHeaderDetails: (details: any | ((prev: any) => any)) => void;
  setRows: (rows: any[]) => void;
}

export const useCreditNoteVoucherNavigation = ({
  initialVoucher,
  activeTab,
  vouchers,
  setHeaderDetails,
  setRows,
}: UseCreditNoteVoucherNavigationProps) => {
