...
import { useCreditNoteBarcodeScanner } from './useCreditNoteBarcodeScanner';
import { useCreditNoteVoucherTotals } from './useCreditNoteVoucherTotals';
import { useCreditNoteVoucherNavigation } from './useCreditNoteVoucherNavigation';
...
export const useCreditNoteVoucherLogic = (props: VoucherEntryViewProps) => {
  ...
  const totals = useCreditNoteVoucherTotals({
    rows,
    activeTab,
    headerDetails,
  });
  ...
  const {
    ...
    loadRecord,
    handleNavigate,
  } = useCreditNoteVoucherNavigation({
    initialVoucher,
    activeTab,
    vouchers,
    setHeaderDetails,
