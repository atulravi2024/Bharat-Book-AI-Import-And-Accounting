...
import { useCreditNoteVoucherLogic } from './hooks/useCreditNoteVoucherLogic';
import { VoucherEntryViewProps } from './types';

export const CreditNoteVoucher: React.FC<VoucherEntryViewProps> = (props) => {
  const logic = useCreditNoteVoucherLogic(props);
