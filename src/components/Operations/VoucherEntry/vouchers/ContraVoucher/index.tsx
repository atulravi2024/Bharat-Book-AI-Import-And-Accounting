...
import { useContraVoucherLogic } from './hooks/useContraVoucherLogic';
import { VoucherEntryViewProps } from './types';

export const ContraVoucher: React.FC<VoucherEntryViewProps> = (props) => {
  const logic = useContraVoucherLogic(props);
