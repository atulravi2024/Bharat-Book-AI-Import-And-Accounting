...
import { useSalesBarcodeScanner } from './useSalesBarcodeScanner';
import { useSalesVoucherTotals } from './useSalesVoucherTotals';
import { useSalesVoucherNavigation } from './useSalesVoucherNavigation';
...
export const useSalesVoucherLogic = (props: VoucherEntryViewProps) => {
  ...
  const totals = useSalesVoucherTotals({
    rows,
    activeTab,
    headerDetails,
  });
