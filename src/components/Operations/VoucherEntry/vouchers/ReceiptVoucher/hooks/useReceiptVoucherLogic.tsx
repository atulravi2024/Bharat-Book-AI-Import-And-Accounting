...
import { useReceiptBarcodeScanner } from './useReceiptBarcodeScanner';
import { useReceiptVoucherTotals } from './useReceiptVoucherTotals';
import { useReceiptVoucherNavigation } from './useReceiptVoucherNavigation';
...
export const useReceiptVoucherLogic = (props: VoucherEntryViewProps) => {
  ...
  const totals = useReceiptVoucherTotals({
    rows,
    activeTab,
    headerDetails,
  });
