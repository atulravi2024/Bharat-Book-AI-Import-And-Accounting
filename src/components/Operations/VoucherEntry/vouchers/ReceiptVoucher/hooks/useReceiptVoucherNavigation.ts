...
interface UseReceiptVoucherNavigationProps {
  initialVoucher: any;
  activeTab: string;
  vouchers: any[];
  setHeaderDetails: React.Dispatch<React.SetStateAction<any>>;
  setRows: React.Dispatch<React.SetStateAction<any[]>>;
}

export const useReceiptVoucherNavigation = ({
  initialVoucher,
  activeTab,
  vouchers,
  setHeaderDetails,
  setRows,
}: UseReceiptVoucherNavigationProps) => {
