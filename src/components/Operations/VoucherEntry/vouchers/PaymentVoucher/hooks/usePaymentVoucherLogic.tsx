...
import { usePaymentBarcodeScanner } from './usePaymentBarcodeScanner';
import { usePaymentVoucherTotals } from './usePaymentVoucherTotals';
import { usePaymentVoucherNavigation } from './usePaymentVoucherNavigation';
...
export const usePaymentVoucherLogic = (props: VoucherEntryViewProps) => {
  ...
  const totals = usePaymentVoucherTotals({
    rows,
    activeTab,
    headerDetails,
  });
