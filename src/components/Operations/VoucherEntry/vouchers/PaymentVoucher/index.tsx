...
import { usePaymentVoucherLogic } from './hooks/usePaymentVoucherLogic';
import { VoucherEntryViewProps } from './types';

export const PaymentVoucher: React.FC<VoucherEntryViewProps> = (props) => {
  const logic = usePaymentVoucherLogic(props);
