...
import { useDebitNoteVoucherLogic } from './hooks/useDebitNoteVoucherLogic';
import { VoucherEntryViewProps } from './types';

export const DebitNoteVoucher: React.FC<VoucherEntryViewProps> = (props) => {
  const logic = useDebitNoteVoucherLogic(props);
