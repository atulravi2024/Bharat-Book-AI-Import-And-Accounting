...
import { useDebitNoteBarcodeScanner } from './useDebitNoteBarcodeScanner';
import { useDebitNoteVoucherTotals } from './useDebitNoteVoucherTotals';
import { useDebitNoteVoucherNavigation } from './useDebitNoteVoucherNavigation';
...
export const useDebitNoteVoucherLogic = (props: VoucherEntryViewProps) => {
  ...
  const totals = useDebitNoteVoucherTotals({
    rows,
    activeTab,
    headerDetails,
  });
