    ...
    <div className="fixed bottom-0 left-0 right-0 pb-[env(safe-area-inset-bottom)] md:sticky md:bottom-0 md:-mx-6 lg:-mx-8 md:-mb-6 lg:-mb-8 z-[60] md:z-50 bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] p-2 md:p-1.5 flex justify-end md:justify-between items-center px-4 md:px-6 lg:px-8 mt-4 md:mt-4 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="flex gap-1 overflow-x-auto custom-scrollbar py-0.5 items-center">
         ...
         <div className={`${isSection0Collapsed ? 'hidden md:flex' : 'flex'} gap-1 animate-in slide-in-from-right-2 duration-300`}>
           ...
           <button onClick={handleSave} title={t("Save")} className="p-1 bg-emerald-600 text-white rounded-xl hover:bg-emerald-700 transition-all shadow-sm active:scale-95 shrink-0">
             <Save size={18} />
           </button>
         ...
         <div className={`${isSection1Collapsed ? 'hidden md:flex' : 'flex'} gap-1 animate-in slide-in-from-right-2 duration-300`}>
           <button onClick={() => setShowHistory(true)} title={t("View History")} className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-700">
           ...
           <button onClick={() => setShowCalculator(true)} title={t("Calculator")} className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-700">
             <Calculator size={18} />
           </button>
           <button onClick={handleDuplicateEntry} title={t("Duplicate Entry")} className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-700">
             <PlusCircle size={18} />
           </button>
         </div>
         ...
         <div className={`${isSection2Collapsed ? 'hidden md:flex' : 'flex'} gap-1 animate-in slide-in-from-right-2 duration-300`}>
           ...
           <button onClick={handleSavePrint} title={t("Save & Print")} className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200">
             <Printer size={18} />
           </button>
           <button onClick={handleSaveNew} title={t("Save & New")} className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200">
             <FilePlus size={18} />
           </button>
           <button onClick={handleSaveDraft} title={t("Save as Draft")} className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200">
             <Bookmark size={18} />
           </button>
           <button onClick={handlePreview} title={t("Print Preview")} className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200">
             <Eye size={18} />
           </button>
           <button onClick={handleGeneratePDF} title={t("Generate PDF")} className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200">
             <FileText size={18} />
           </button>
           <button onClick={handleGenerateImage} title={t("Generate Image")} className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200">
             <Image size={18} />
           </button>
         </div>
         ...
         <div className={`${isSection3Collapsed ? 'hidden md:flex' : 'flex'} gap-1 animate-in slide-in-from-right-2 duration-300`}>
           ...
           <button onClick={() => setShowHelp(true)} title={t("Help")} className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-700">
             <HelpCircle size={18} />
           </button>
           {onOpenPrintSettings && (
             <button onClick={() => onOpenPrintSettings()} title={t("Print Settings")} className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-700">
               <Settings2 size={18} />
             </button>
           )}
         </div>
