        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in slide-in-from-top-2 duration-300">
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              ...
              <div className="sm:w-40 flex items-center justify-center px-4 py-3 bg-emerald-50 border border-emerald-100/50 rounded-xl text-sm font-black text-emerald-700 shadow-sm shrink-0 whitespace-nowrap uppercase tracking-widest ring-1 ring-emerald-200/50">
                  {(() => {
