...
export const LogisticsSection: React.FC<LogisticsSectionProps> = ({
  ...
  return (
    <div className={`bg-white border border-gray-200/60 shadow-sm relative transition-all duration-300 z-[37] mb-6 ${collapsedSections.logistics ? 'px-6 py-3 rounded-xl' : 'p-6 rounded-2xl'}`}>
