...
export const InventoryActionMenu: React.FC<InventoryActionMenuProps> = ({
  ...
  return (
    <div className="sticky bottom-0 -mx-4 md:-mx-6 lg:-mx-8 -mb-1 bg-white border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] p-1.5 flex justify-end md:justify-between items-center z-50 px-4 md:px-6 lg:px-8 mt-4">
      ...
      <div className="flex gap-1 overflow-x-auto no-scrollbar py-0.5 items-center">
         ...
         <div className={`${isSection1Collapsed ? 'hidden md:flex' : 'flex'} gap-1 animate-in slide-in-from-right-2 duration-300`}>
           <button onClick={() => setShowHistory(true)} title="View History" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
             <ClipboardList size={18} />
           </button>
           <button onClick={(e) => { e.stopPropagation(); setScanningRowIndex(-1); setShowScanner(true); }} title="Scan Barcode" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
             <ScanBarcode size={18} />
           </button>
           <label htmlFor="inventory-file-upload" title="Attach Files" className="relative p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0 cursor-pointer flex items-center justify-center">
           ...
           <button onClick={() => setShowCalculator(true)} title="Calculator" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
             <Calculator size={18} />
           </button>
           <button onClick={handleDuplicateEntry} title="Duplicate Entry" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
             <PlusCircle size={18} />
           </button>
         </div>
         ...
         <div className={`${isSection2Collapsed ? 'hidden md:flex' : 'flex'} gap-1 animate-in slide-in-from-right-2 duration-300`}>
           ...
           <button onClick={handleSavePrint} title="Save & Print" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
             <Printer size={18} />
           </button>
           <button onClick={handleSaveNew} title="Save & New" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
             <FilePlus size={18} />
           </button>
           <button onClick={handleSaveDraft} title="Save as Draft" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
             <Bookmark size={18} />
           </button>
           <button onClick={handlePreview} title="Print Preview" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
             <Eye size={18} />
           </button>
           <button onClick={handleGeneratePDF} title="Generate PDF" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
             <FileText size={18} />
           </button>
           <button onClick={handleGenerateImage} title="Generate Image" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-emerald-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
             <Image size={18} />
           </button>
         </div>
         ...
         <div className={`${isSection3Collapsed ? 'hidden md:flex' : 'flex'} gap-1 animate-in slide-in-from-right-2 duration-300`}>
           ...
           <button onClick={() => setShowKeyboardShortcuts(true)} title="Keyboard Shortcuts" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
             <Keyboard size={18} />
           </button>
           <button onClick={() => setShowHelp(true)} title="Help" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
             <HelpCircle size={18} />
           </button>
           {onOpenPrintSettings && (
             <button onClick={() => onOpenPrintSettings()} title="Print Settings" className="p-1 bg-white border border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:text-emerald-600 transition-all shadow-sm active:scale-95 shrink-0">
               <Settings2 size={18} />
             </button>
           )}
         </div>
