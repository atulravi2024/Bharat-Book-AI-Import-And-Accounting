...
export const Sidebar: React.FC<SidebarProps> = ({ isSidebarOpen, setIsSidebarOpen, activeView, onViewChange }) => {
  ...
  return (
    <aside className={`fixed top-0 left-0 h-screen z-[70] bg-white shadow-[20px_0_40px_rgba(0,0,0,0.02)] border-r border-premium-slate-100 transition-all duration-300 md:duration-500 ease-in-out md:relative flex flex-col overflow-hidden max-md:w-64 ${
      isSidebarOpen 
