      ...
      <table className="w-full text-sm text-left">
        <thead>
          <tr className="bg-gray-50 border-b">
            ...
            <th className="px-4 py-3 font-bold text-gray-600 uppercase text-[10px]">REF / Invoice No.</th>
            <th className="px-4 py-3 font-bold text-gray-600 uppercase text-[10px] text-right">Withdrawal</th>
            <th className="px-4 py-3 font-bold text-gray-600 uppercase text-[10px] text-right">Deposit</th>
            <th className="px-4 py-3 font-bold text-gray-600 uppercase text-[10px] text-right">Balance</th>
          </tr>
        </thead>
        <tbody>
          {data.map(v => (
            <tr key={v.id} className="border-b hover:bg-gray-50 transition-colors">
              ...
              <td className="px-4 py-3 font-mono text-xs text-gray-500">{String(v.referenceNo?.value || '-')}</td>
        ...
        {data.length > 0 && (
          <tfoot>
            <tr className="bg-gray-50 font-bold border-t-2 border-gray-200">
              <td colSpan={3} className="px-4 py-4 text-right uppercase text-[10px] tracking-widest text-gray-500">Total Movements</td>
