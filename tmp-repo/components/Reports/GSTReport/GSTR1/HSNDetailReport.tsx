      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 py-2">
        <div className="flex bg-gray-100 p-1 rounded-lg w-fit">
          {['All', 'B2B', 'B2C'].map((opt) => (
            <button
              ...
              className={`px-4 py-1.5 rounded-md text-[10px] uppercase font-bold tracking-tighter transition-all ${filter === opt ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-400 hover:text-gray-600'}`}
            >
              {opt} Detail
            </button>
          ))}
        ...
        <div className="relative">
            ...
            <input 
                ...
                className="pl-10 pr-4 py-2 border rounded-lg text-sm bg-gray-50 focus:bg-white transition-all outline-none md:w-64"
                value={searchTerm}
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {b2bNormalHsn.map((h, i) => (
                                <tr key={i} className="hover:bg-gray-50/80 transition-colors">
                                    ...
                                    <td className="px-4 py-3 text-gray-500 truncate max-w-[200px]" title={h.desc}>{h.desc || '-'}</td>
