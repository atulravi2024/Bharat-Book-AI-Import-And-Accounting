            ...
            <div className="space-y-4">
                <div className="flex justify-between items-center bg-gray-50 p-4 rounded-xl border border-gray-100">
                    <div className="flex items-center">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 font-medium">admin@bharatbook.com</p>
                        </div>
                    </div>
                ...
                <div className="flex justify-between items-center bg-gray-50 p-4 rounded-xl border border-gray-100">
                    <div className="flex items-center">
                        ...
                        <div>
                            <p className="font-bold text-gray-900 text-sm">Sales Team</p>
                            <p className="text-xs text-gray-500 font-medium">sales@bharatbook.com</p>
                        </div>
                    </div>
                ...
                <button className="w-full py-4 border-2 border-dashed border-gray-200 rounded-xl text-gray-400 font-bold hover:border-blue-300 hover:text-blue-600 hover:bg-blue-50 transition-colors uppercase tracking-widest text-xs flex justify-center items-center">
