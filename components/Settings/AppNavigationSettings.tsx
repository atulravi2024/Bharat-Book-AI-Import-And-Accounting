...
import { SettingsIcon, CheckCircleIcon, ExpandMoreIcon, AIToolsIcon, InfoIcon } from '../icons/IconComponents';
...
export const AppNavigationSettings: React.FC = () => {
    ...
    const [routingDefaults, setRoutingDefaults] = useState<Record<string, string>>({
        dashboard: 'main',
        import: 'upload',
    ...
    const handleSave = () => {
        localStorage.setItem('bharat_book_navigation_defaults', JSON.stringify({
            page: defaultPage,
    ...
    const handleReset = () => {
        ...
        localStorage.setItem('bharat_book_navigation_defaults', JSON.stringify(defaults));
        setIsSaved(true);
        ...
        <div className="flex flex-col gap-8 pb-20">
            ...
            <div className="bg-white rounded-[3rem] p-10 border border-gray-100 shadow-sm relative overflow-hidden group dark:bg-gray-800 dark:border-gray-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest px-2 text-right">Immediate access to: {subPages[defaultPage]?.find(sp => sp.id === defaultSubPage)?.label}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-[3rem] p-10 border border-gray-100 shadow-sm relative overflow-hidden group dark:bg-gray-800 dark:border-gray-800">
                ...
                <div className="mt-12 p-8 bg-blue-50/50 rounded-[2.5rem] border border-blue-100 flex gap-6 items-center relative z-10">
                    ...
                    <div>
                        <h4 className="text-sm font-black text-blue-900 uppercase tracking-[0.15em] mb-2">Architectural Integrity</h4>
                        <p className="text-xs text-blue-700/60 font-medium leading-[1.8] max-w-2xl italic">"These routing rules persist across user sessions, ensuring your workflow remains uninterrupted by creating dedicated direct-access pathways to your most critical data silos."</p>
                    </div>
                </div>
            </div>
        </div>
