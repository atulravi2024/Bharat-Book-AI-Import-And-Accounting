...
export const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[110] p-4 animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl p-6 ring-1 ring-black/5 animate-in zoom-in-95 duration-200 dark:bg-gray-800">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1 pt-1">
            ...
            <p className="text-sm text-gray-600 leading-relaxed dark:text-gray-300">{message}</p>
          </div>
        </div>
        <div className="flex justify-end gap-3">
          <button 
            onClick={onCancel}
            className="px-5 py-2.5 rounded-xl text-sm font-bold text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 transition-colors shadow-sm active:scale-95 dark:text-gray-200 dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-700"
          >
            {cancelText}
          </button>
          <button 
